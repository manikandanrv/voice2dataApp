...
export default function DoublerPrimarySizeParser() {
    ...
    const fetchMasters = async () => {
        try {
            let url = `${API_BASE}/doubler-primary-masters?page=${masterPage}&limit=5`;
    ...
    const handleParse = async (e) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/parse-doubler-primary-size?size_string=${encodeURIComponent(sizeCode)}`, {
                method: 'POST',
    ...
    const handleAddToMaster = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE}/doubler-primary-masters`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            if (res.ok) {
                setAddMessage('Success: Added to Doubler Primary Master!');
    ...
    return (
        <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
                ...
                <div style={cardStyle}>
                    ...
                    <form onSubmit={handleParse} style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem' }}>
                        <input
                            ...
                            placeholder="Enter Code (e.g. 6DPHN3POGM01V)"
                            style={inputStyle}
                        />
                            ...
                            {(!result.errors || result.errors.length === 0) && (
                                <>
                                    ...
                                    <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '1rem' }}>
                                        ...
                                        >
                                            {addingMaster ? 'Adding to Master...' : '✓ Add to Doubler Primary Master'}
                                        </button>
                                        {addMessage && (
                ...
                {/* Master List Section */}
                <div style={cardStyle}>
                    <h3 style={sectionHeaderStyle}>Existing Doubler Primary Masters</h3>
