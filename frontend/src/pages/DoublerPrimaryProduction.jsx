...
const DoublerPrimaryProduction = () => {
    // Main Data State
    ...
    const fetchEntries = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE}/production/doubler-primary/?${queryParams}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (activeTab === 'production') {
                url = editingId
                    ? `${API_BASE}/production/doubler-primary/${editingId}`
                    : `${API_BASE}/production/doubler-primary/`;
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Delete this entry?')) {
            await fetch(`${API_BASE}/production/doubler-primary/${id}`, { method: 'DELETE' });
            fetchEntries();
        }
    };
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Doubler Primary Production</h1>
...
export default DoublerPrimaryProduction;
